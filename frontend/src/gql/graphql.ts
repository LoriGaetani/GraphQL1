...
export type GetBooksQuery = { getAllBooks: Array<{ id: string, title: string, isbn: string, publishedYear: number, authors: Array<{ id: string, firstName: string, lastName: string }> }> };
